...
namespace SimpleSolution.Data.DAL
{
    public class SimpleInitializer : DropCreateDatabaseIfModelChanges<SimpleContext>
    {
        ...
        private void SeedSimpleData(SimpleContext context)
        {
            ...
            {
                new Student() {StudentId = Guid.Parse("5bfc3adf-b6ae-4eb3-96f7-9bf4f44ca5f6"), Name = "Imie", Surname = "Nazwisko"},
                new Student() {StudentId = Guid.Parse("fc2f4d28-1d08-4f4c-a8dc-e0ef6e3028dd"), Name = "Imie", Surname = "Nazwisko"}
            };
